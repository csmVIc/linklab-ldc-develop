...
jlink_thread_pool = []
term_thread_pool = []
soft_device_path = "/app/tool/nRF52840/shell/s140_nrf52_7.0.1_softdevice.hex"  # 必须为绝对路径
...
class JLink_IF:  # RTT输出的接口
    ...
    def __init__(self, sn, log_file_name=None, buffer_len=100):
        ...
        if log_file_name is not None:
            ...
            self.log_file = open("/app/tool/nRF52840/shell" + log_file_name + "_" + str(self.sn) + ".log", 'w+')
