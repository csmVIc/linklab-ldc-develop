...
func (td *Driver) init() error {
	...
	ts["$share/device-service/clients/+/+/publish/device/endrun"] = mqttclient.SubTopic{
		MsgHandler: td.deviceendrun,
		Qos:        2,
	}
	ts["$share/device-service/clients/+/+/publish/device/burnresult"] = mqttclient.SubTopic{
		MsgHandler: td.deviceburnresult,
		Qos:        2,
	}
	ts["$share/device-service/clients/+/+/publish/device/execerr"] = mqttclient.SubTopic{
		MsgHandler: td.execerr,
		Qos:        2,
	}
	td.topicToSub = &ts
	return nil
